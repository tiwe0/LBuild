...
# Mutation-aware guards for the intentionally retained compiler boundaries.
# These checks ensure a future edit cannot silently weaken the conservative
# behavior while the full ABI fixtures are still pending.
